...
public final class JsonDiffTest {
    ...
    public JsonDiffTest()
            throws IOException {
        final String resource = "/jsonpatch/diff/diffTest.json";
    ...
    public void generatedPatchAppliesCleanly(final JsonNode first,
                                             final JsonNode second) throws JsonPatchException {
 ...
 /*   @Test(dataProvider = "getPatchesOnly")
    public void testCase1(final JsonNode first, final JsonNode second) throws IOException {
        *//**as per programer *//*
        *//*final String resource_one = "/jsonpatch/diff/diffTest.json";
        final JsonNode first = JsonLoader.fromResource(resource_one);

        final String resource_two = "/jsonpatch/diff/diffTest.json";
        final JsonNode second = JsonLoader.fromResource(resource_two);*//*

        JsonPatch patch = JsonDiff.asJsonPatch(first, second,null);
        Assert.assertEquals(patch,second);
    }*/

    @Test(dataProvider = "getPatchesOnly")
    public void testcase1(final JsonNode first,
                          final JsonNode second) throws JsonPatchException {
